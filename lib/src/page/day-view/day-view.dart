...
import 'package:diatrofi/src/services/database.dart';
import 'dart:math';
import 'package:diatrofi/src/utils/theme_colors.dart';
import 'package:diatrofi/src/utils/constants.dart';
    ...
    return Scaffold(
        ...
        body: StreamProvider<List<FoodTrackTask>>.value(
          ...
          value: new DatabaseService(
                  uid: "diatrofi-app-f1701", currentDate: DateTime.now())
              .foodTracks,
